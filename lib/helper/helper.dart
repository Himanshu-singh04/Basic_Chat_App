...
class Helper_functions {
  ...
  static Future<String?> get_user_email_from_SF() async {
    SharedPreferences sf = await SharedPreferences.getInstance();
    return sf.getString(user_email_key);
  }

  static Future<String?> get_user_name_from_SF() async {
    SharedPreferences sf = await SharedPreferences.getInstance();
    return sf.getString(user_name_key);
  }
}
